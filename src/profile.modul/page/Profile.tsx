      ...
      <div className="h-screen bg-transparent dark:bg-transparent p-4 md:p-2">
        <div className="max-w-5xl mx-auto space-y-6">
          ...
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-4 mb-2">
            ...
            {/* Mobile edit button (visible on small screens) */}
            <button className="inline-flex md:hidden items-center gap-2 px-5 py-2.5 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-xl text-sm font-medium text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700 hover:border-gray-300 dark:hover:border-gray-600 transition-all shadow-sm w-full justify-center">
              <svg
                className="w-4 h-4"
                fill="none"
                stroke="currentColor"
